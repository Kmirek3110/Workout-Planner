                            ...
                            return (
                                ...
                                <div key = {exercise.exercise_name}>
                                    ...
                                    <div className = "row">
                                        ...
                                        <button className = "btn btn-primary wrkbutton" onClick  = {() => ExrEditForm(workout, exercise)}> Edit Exercise</button>
                              
                                        <button className = "btn btn-danger wrkbutton" onClick  = {() => deleteExcr(workout,exercise)}> Delete exercise</button>
