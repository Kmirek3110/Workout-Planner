  ...
  return (
    <div>
            ...
            return (
              <div key={plan.plan_name}>
                ...
                <div className="column">
                  <button
                    className="btn btn-danger plnbtn"
                  ...
                  <button
                    className="btn btn-dark plnbtn"
                    onClick={() => PlanDoneForm(plan)}
                  >
                    {" "}
                    Plan Instance Done
                  </button>
                  {showDoneForm && chosenPlan === plan.id && (
                    <FinishedForm plan={plan} />
                  )}
                </div>
              </div>
            );
      ...
      <div className="Row">
        <button
          type="button"
          className="btn btn-success middle"
        ...
        <button
          ...
          onClick={() => history.push(`/generate-plan`)}
        >
